...
# Setup production with Supervisor + Nginx
echo "[+] Configuring Supervisor and Nginx..."
sudo -i -u $USER bash <<EOF
cd $BENCH_DIR
...
# Fix permissions so nginx (www-data) can serve assets
...
echo "[+] Production setup complete. Access via: http://<your-server-ip>"
